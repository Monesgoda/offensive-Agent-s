...
An offensive security framework built on OpenCode featuring a primary orchestration agent and 24 specialized sub-agents for authorized penetration testing, bug bounty programs, and CTF challenges.
...
└── 24 Specialized Sub-Agents
    ...
    ├── Network & Infra: network-attacker, ad-attacker, cloud-security, 
    │                    container-breakout, database-attacker
    ├── Exploitation: payload-crafter, exploit-guide, exploit-chainer, 
    │                 attack-planner, lateral-movement, privesc-advisor
