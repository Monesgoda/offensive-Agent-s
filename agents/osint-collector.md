...
shodan search "org:'ACME Corporation' port:3389"
...
# Google: site:linkedin.com/in "ACME Corporation" "security engineer"
# Google: site:linkedin.com/in "target.com"

# CrossLinked - automated LinkedIn name scraping via search engines
crosslinked -f '{first}.{last}@target.com' -t 'ACME Corporation' -j 2

# linkedin2username - generate username lists from company LinkedIn
python3 linkedin2username.py -c "ACME Corporation" -d target.com
```
...
# Search: site:linkedin.com/jobs "ACME Corporation" ("Kubernetes" OR "AWS" OR "React")
# Search: site:indeed.com "ACME Corporation" ("Python" OR "Java" OR "Jenkins")
```
...
# Search: org:acmecorp filename:.env
# Search: org:acmecorp filename:id_rsa
...
python3 cloud_enum.py -k target -k "ACME Corporation" --disable-azure --disable-gcp
